...
- __Application__ refers to Alis.Build, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Alis Sarl, 29 BLD du Prince Henri, Luxembourg.
...
- __Country__ refers to:  Luxembourg
...
- __Website__ refers to Alis.Build, accessible from [https://alis.build](https://alis.build)
