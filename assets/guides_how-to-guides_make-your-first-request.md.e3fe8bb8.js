...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="_2-make-a-request" tabindex="-1">2. Make a request <a class="header-anchor" href="#_2-make-a-request" aria-hidden="true">#</a></h2><p>The <code>booksClient</code> provides you all the methods available, with descriptions of the methods and a specification of what the request and responses are. Most IDEs allow you to explore these by hovering over client and method names, similar to the example shown below.</p><p>Let us make our requests.</p><h4 id="list-books" tabindex="-1">List books <a class="header-anchor" href="#list-books" aria-hidden="true">#</a></h4><p>Firstly we will get a list of all the books by calling the <code>ListBooks</code> method and then print their display names in the console.</p><p>Add the <code>printBookNames</code> function to the bottom of your Go file and make a call to the function from <code>main</code>.</p><div class="language-go"><button class="copy"></button><span class="lang">go</span><pre><code><span class="token keyword">package</span> main
...
<span class="token punctuation">}</span>
</code></pre></div><h4 id="get-book" tabindex="-1">Get book <a class="header-anchor" href="#get-book" aria-hidden="true">#</a></h4><p>Secondly, we will get a specific book and print all of its information in the console.</p><p>Add the <code>printBookDetails</code> function to the bottom of your Go file and make a call to the function from <code>main</code> with the provided book name.</p><div class="language-go"><button class="copy"></button><span class="lang">go</span><pre><code><span class="token keyword">package</span> main
...
<span class="token keyword">func</span> <span class="token function">printBookDetails</span><span class="token punctuation">(</span>bookName <span class="token builtin">string</span><span class="token punctuation">)</span> <span class="token punctuation">(</span><span class="token builtin">string</span><span class="token punctuation">,</span> <span class="token builtin">error</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	<span class="token keyword">return</span> <span class="token string">&quot;Done!&quot;</span><span class="token punctuation">,</span> <span class="token boolean">nil</span>
<span class="token punctuation">}</span>
</code></pre></div><h3 id="full-code-example" tabindex="-1">Full code example <a class="header-anchor" href="#full-code-example" aria-hidden="true">#</a></h3><p>The complete code for both examples is available below.</p><details class="details custom-block"><summary>Click here to view full code example.</summary><div class="language-go"><button class="copy"></button><span class="lang">go</span><pre><code><span class="token keyword">package</span> main
