import{_ as l,D as p,o as u,c as i,G as t,B as a,O as c,z as n,a as s}from"./chunks/framework.600d1dda.js";const nn=JSON.parse('{"title":"Implement the Books Service","description":"","frontmatter":{},"headers":[],"relativePath":"guides/how-to-guides/build-a-service/implement.md","filePath":"guides/how-to-guides/build-a-service/implement.md"}'),r={name:"guides/how-to-guides/build-a-service/implement.md"},k=c('<h1 id="implement-the-books-service" tabindex="-1">Implement the Books Service <a class="header-anchor" href="#implement-the-books-service" aria-label="Permalink to &quot;Implement the Books Service&quot;">​</a></h1><p>The implementation of our <code>BooksService</code> entails using the proto definition and protobuf packages created in the <a href="./design.html">previous step</a> and combining them with our programming language of choice to bring them to life.</p><h2 id="create-neuron" tabindex="-1">Create neuron <a class="header-anchor" href="#create-neuron" aria-label="Permalink to &quot;Create neuron&quot;">​</a></h2><p>To create a new neuron, run <code>alis neuron create {orgID}.{productID}.{resources|services}-{neuronName}-{neuronVersion}</code> (e.g. <code>alis neuron create xmpl.br.resources-books-v1</code>). Upon creating a neuron, you will be prompted whether you would like boilerplate code. Type <code>y</code> and select the language which you would like to implement the server in. This will populate your neuron&#39;s directory with the necessary boilerplate code: Terraform for infrastructure and the language of choice for code implementation.</p><h2 id="specify-infrastructure" tabindex="-1">Specify infrastructure <a class="header-anchor" href="#specify-infrastructure" aria-label="Permalink to &quot;Specify infrastructure&quot;">​</a></h2><p>The neuron comes with the most basic infrastructure necessary to host your server on <a href="https://cloud.google.com/run" target="_blank" rel="noreferrer">Cloud Run</a>. This includes:</p><ol><li><code>cloudrun.tf</code> - specifies the cloudrun service infrastructure</li><li><code>main.tf</code> - for setting up the required terraform providers</li><li><code>variables.tf</code> - specifies the environment variables needed. Any additional variables added must also be specified in the <code>cloudrun.tf</code></li></ol><p>If you wish to make use of different cloud architecture to host your neuron, you can remove, add and change the Terraform spec as required.</p><h2 id="implement-code" tabindex="-1">Implement code <a class="header-anchor" href="#implement-code" aria-label="Permalink to &quot;Implement code&quot;">​</a></h2><p>Once you have released your protos, implementation of the server can begin. This is done by creating a new <a href="./../../references/conceptual-framework.html">neuron</a> on Alis Exchange. To create a new neuron, run <code>alis neuron create {orgID}.{productID}.{resources|services}-{neuronName}-{neuronVersion}</code> (e.g. <code>alis neuron create xmpl.br.resources-books-v1</code>). Upon creating a neuron, you will be prompted whether you would like boilerplate code. Type <code>y</code> and select the language which you would like to implement the server in.</p><p>The boilerplate code that is given to you will look something like this:</p><p><strong>Server</strong></p><p>The <code>server</code> is responsible for registering your implementation of the service interface (as implemented in the <code>methods</code>) with the gRPC server and makes this available to serve traffic on the specified port (the default port for cloud run).</p>',13),d=n("div",{class:"language-go"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"go"),n("pre",null,[n("code",null,[n("span",{class:"token keyword"},"package"),s(` main
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])])],-1),m=n("div",{class:"language-python"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"python"),n("pre",null,[n("code",null,[n("span",{class:"token keyword"},"from"),s(" concurrent "),n("span",{class:"token keyword"},"import"),s(` futures
...
`)])])],-1),b=n("div",{class:"language-python"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"python"),n("pre",null,[n("code",null,[n("span",{class:"token keyword"},"import"),s(` grpc
`),n("span",{class:"token keyword"},"import"),s(` logging
...
`)])])],-1),w=n("div",{class:"language-python"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"python"),n("pre",null,[n("code",null,[n("span",{class:"token keyword"},"import"),s(` unittest
...
`)])])],-1),B=n("div",{class:"language-docker"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"docker"),n("pre",null,[n("code",null,[n("span",{class:"token instruction"},[n("span",{class:"token keyword"},"FROM"),s(" python:3.8-slim")]),s(`
...
`)])])],-1),j=c('<div class="tip custom-block"><p class="custom-block-title">TIP</p><p>Note that some of the clients you would like to create (like a Firestore client) require a google project with the Firestore API enabled. In this case, you will only be able to test your methods with the live Firestore after first creating a neuron deployment as the neuron deployment will set up the google project under which the Firestore Table will exist.</p><p>Alternatively, one could use a <a href="https://firebase.google.com/docs/emulator-suite" target="_blank" rel="noreferrer">local, emulated firestore instance for testing</a>.</p></div><h3 id="implementing-the-methods" tabindex="-1">Implementing the methods <a class="header-anchor" href="#implementing-the-methods" aria-label="Permalink to &quot;Implementing the methods&quot;">​</a></h3><p>Below is an example implementation of the CRUD methods for the <code>BooksService</code> which integrates with FireStore:</p>',3),H=n("div",{class:"language-go"},[n("button",{title:"Copy Code",class:"copy"}),n("span",{class:"lang"},"go"),n("pre",null,[n("code",null,[n("span",{class:"token keyword"},"package"),s(` main
...
`)])])],-1),$=n("div",{class:"info custom-block"},[n("p",{class:"custom-block-title"},"INFO"),n("p",null,"Coming soon")],-1);function z(J,K,W,Y,X,Z){const o=p("tab"),e=p("tabs");return u(),i("div",null,[k,t(e,null,{default:a(()=>[t(o,{name:"Go"},{default:a(()=>[d]),_:1}),t(o,{name:"Python"},{default:a(()=>[m]),_:1})]),_:1}),g,f,t(e,null,{default:a(()=>[t(o,{name:"Go"},{default:a(()=>[h]),_:1}),t(o,{name:"Python"},{default:a(()=>[b]),_:1})]),_:1}),y,_,t(e,null,{default:a(()=>[t(o,{name:"Go"},{default:a(()=>[v]),_:1}),t(o,{name:"Python"},{default:a(()=>[w]),_:1})]),_:1}),C,S,t(e,null,{default:a(()=>[t(o,{name:"Go"},{default:a(()=>[x]),_:1}),t(o,{name:"Python"},{default:a(()=>[B]),_:1})]),_:1}),T,R,t(e,null,{default:a(()=>[t(o,{name:"Go"},{default:a(()=>[q,I,P]),_:1}),t(o,{name:"Python"},{default:a(()=>[O,E]),_:1})]),_:1}),G,t(e,null,{default:a(()=>[t(o,{name:"Go"},{default:a(()=>[A]),_:1}),t(o,{name:"Python"},{default:a(()=>[N]),_:1})]),_:1}),D,t(e,null,{default:a(()=>[t(o,{name:"Go"},{default:a(()=>[L,U,F]),_:1}),t(o,{name:"Python"},{default:a(()=>[M,V]),_:1})]),_:1}),j,t(e,null,{default:a(()=>[t(o,{name:"Go"},{default:a(()=>[H]),_:1}),t(o,{name:"Python"},{default:a(()=>[$]),_:1})]),_:1})])}const sn=l(r,[["render",z]]);export{nn as __pageData,sn as default};
